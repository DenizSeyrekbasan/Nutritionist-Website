  ...
  return (
    <div className="mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8 rounded-3xl">
      <div className="bg-build pt-12 px-10 sm:px-24 pb-52 md:pb-70 rounded-3xl">
        ...
        <p className="text-2xl pt-2 mb-5 text-center sm:text-start flex items-center">
        ...
        <p className="text-2xl pt-2 mb-5 text-center sm:text-start">
        ...
        <div className="text-2xl pt-2 mb-5 text-center sm:text-start">
